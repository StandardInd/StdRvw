...
public class activity_account extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.include_account).setVisibility(View.VISIBLE);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            startActivity(new Intent(activity_account.this, activity_categorie.class));

        } else if (id == R.id.nav_myreview) {
            startActivity(new Intent(activity_account.this, activity_myreview.class));
